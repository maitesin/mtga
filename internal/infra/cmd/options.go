...
type Options struct {
	...
	Foil      bool   `short:"f" long:"foil" default:"false" description:"Foil card"`
	Altered   bool   `short:"a" long:"altered" default:"false" description:"Altered card"`
	Signed    bool   `short:"i" long:"signed" default:"false" description:"Signed card"`
